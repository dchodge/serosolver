...
#' @family boosting_functions
#' @seealso \code{\link{titre_data_fast}}
titre_data_fast_individual_base <- function(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps) {
    invisible(.Call('_serosolver_titre_data_fast_individual_base', PACKAGE = 'serosolver', predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps))
}
...
makeFuncPtr <- function(xpsexp) {
    .Call('_serosolver_makeFuncPtr', PACKAGE = 'serosolver', xpsexp)
}
...
#' @export
#' @family titre_model
titre_data_fast <- function(theta, infection_history_mat, vaccination_hist_info, abkinetics_model, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, nrows_per_blood_sample, measurement_strain_indices, antigenic_maps, antigenic_distances, mus, boosting_vec_indices, boost_before_infection = FALSE) {
    .Call('_serosolver_titre_data_fast', PACKAGE = 'serosolver', theta, infection_history_mat, vaccination_hist_info, abkinetics_model, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, nrows_per_blood_sample, measurement_strain_indices, antigenic_maps, antigenic_distances, mus, boosting_vec_indices, boost_before_infection)
}
