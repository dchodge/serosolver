...
titre_data_fast_individual_base <- function(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars) {
    invisible(.Call('_serosolver_titre_data_fast_individual_base', PACKAGE = 'serosolver', predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars))
}
...
#' @family boosting_functions
#' @seealso \code{\link{titre_data_fast}}
titre_data_fast_individual_wane2 <- function(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars) {
    invisible(.Call('_serosolver_titre_data_fast_individual_wane2', PACKAGE = 'serosolver', predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars))
}
...
#' @family boosting_functions
#' @seealso \code{\link{titre_data_fast}}
titre_data_fast_individual_titredep <- function(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars) {
    invisible(.Call('_serosolver_titre_data_fast_individual_titredep', PACKAGE = 'serosolver', predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars))
}
...
#' @family boosting_functions
#' @seealso \code{\link{titre_data_fast}}
titre_data_fast_individual_strain_dependent <- function(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars) {
    invisible(.Call('_serosolver_titre_data_fast_individual_strain_dependent', PACKAGE = 'serosolver', predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps, other_pars))
}

fun_cpp <- function(x) {
    invisible(.Call('_serosolver_fun_cpp', PACKAGE = 'serosolver', x))
}

timesTwo <- function(x) {
    invisible(.Call('_serosolver_timesTwo', PACKAGE = 'serosolver', x))
}

create_ptr <- function() {
    .Call('_serosolver_create_ptr', PACKAGE = 'serosolver')
}

invokeCallback <- function(callback) {
    invisible(.Call('_serosolver_invokeCallback', PACKAGE = 'serosolver', callback))
}

get_callback <- function() {
    .Call('_serosolver_get_callback', PACKAGE = 'serosolver')
}
...
#' @export
#' @family titre_model
titre_data_fast <- function(theta, infection_history_mat, vaccination_hist_info, ab_kin_func, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, nrows_per_blood_sample, measurement_strain_indices, antigenic_maps, antigenic_distances, other_pars, boost_before_infection = FALSE) {
    .Call('_serosolver_titre_data_fast', PACKAGE = 'serosolver', theta, infection_history_mat, vaccination_hist_info, ab_kin_func, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, nrows_per_blood_sample, measurement_strain_indices, antigenic_maps, antigenic_distances, other_pars, boost_before_infection)
}
...
#' @export
#' @family infection_history_proposal
inf_hist_prop_prior_v2_and_v4 <- function(theta, infection_history_mat, vaccination_hist_info, ab_kin_func, old_probs_1, sampled_indivs, n_years_samp_vec, age_mask, strain_mask, n_alive, n_infections, n_infected_group, prior_lookup, swap_propn, swap_distance, propose_from_prior, alpha, beta, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, cum_nrows_per_individual_in_repeat_data, nrows_per_blood_sample, group_id_vec, measurement_strain_indices, antigenic_maps, antigenic_distances, data, repeat_data, repeat_indices, titre_shifts, proposal_iter, accepted_iter, proposal_swap, accepted_swap, overall_swap_proposals, overall_add_proposals, time_sample_probs, other_pars, total_alive, temp = 1, solve_likelihood = TRUE) {
    .Call('_serosolver_inf_hist_prop_prior_v2_and_v4', PACKAGE = 'serosolver', theta, infection_history_mat, vaccination_hist_info, ab_kin_func, old_probs_1, sampled_indivs, n_years_samp_vec, age_mask, strain_mask, n_alive, n_infections, n_infected_group, prior_lookup, swap_propn, swap_distance, propose_from_prior, alpha, beta, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, cum_nrows_per_individual_in_repeat_data, nrows_per_blood_sample, group_id_vec, measurement_strain_indices, antigenic_maps, antigenic_distances, data, repeat_data, repeat_indices, titre_shifts, proposal_iter, accepted_iter, proposal_swap, accepted_swap, overall_swap_proposals, overall_add_proposals, time_sample_probs, other_pars, total_alive, temp, solve_likelihood)
}
