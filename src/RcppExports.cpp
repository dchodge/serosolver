...
void titre_data_fast_individual_base(NumericVector& predicted_titres, const NumericVector& theta, const List& infection_info, const List& vaccination_info, const List& setup_data, const List& indexing, const List& antigenic_maps);
RcppExport SEXP _serosolver_titre_data_fast_individual_base(SEXP predicted_titresSEXP, SEXP thetaSEXP, SEXP infection_infoSEXP, SEXP vaccination_infoSEXP, SEXP setup_dataSEXP, SEXP indexingSEXP, SEXP antigenic_mapsSEXP) {
BEGIN_RCPP
    ...
    titre_data_fast_individual_base(predicted_titres, theta, infection_info, vaccination_info, setup_data, indexing, antigenic_maps);
    return R_NilValue;
END_RCPP
}
// fun_cpp
...
RcppExport SEXP _serosolver_makeFuncPtr(SEXP xpsexpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xpsexp(xpsexpSEXP);
    rcpp_result_gen = Rcpp::wrap(makeFuncPtr(xpsexp));
...
// titre_data_fast
NumericVector titre_data_fast(NumericVector theta, const IntegerMatrix infection_history_mat, const List vaccination_hist_info, const Function abkinetics_model, const NumericVector circulation_times, const IntegerVector circulation_times_indices, const NumericVector sample_times, const IntegerVector rows_per_indiv_in_samples, const IntegerVector cum_nrows_per_individual_in_data, const IntegerVector nrows_per_blood_sample, const IntegerVector measurement_strain_indices, const List antigenic_maps, const NumericVector antigenic_distances, const NumericVector mus, const IntegerVector boosting_vec_indices, bool boost_before_infection);
RcppExport SEXP _serosolver_titre_data_fast(SEXP thetaSEXP, SEXP infection_history_matSEXP, SEXP vaccination_hist_infoSEXP, SEXP abkinetics_modelSEXP, SEXP circulation_timesSEXP, SEXP circulation_times_indicesSEXP, SEXP sample_timesSEXP, SEXP rows_per_indiv_in_samplesSEXP, SEXP cum_nrows_per_individual_in_dataSEXP, SEXP nrows_per_blood_sampleSEXP, SEXP measurement_strain_indicesSEXP, SEXP antigenic_mapsSEXP, SEXP antigenic_distancesSEXP, SEXP musSEXP, SEXP boosting_vec_indicesSEXP, SEXP boost_before_infectionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    Rcpp::traits::input_parameter< const Function >::type abkinetics_model(abkinetics_modelSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(titre_data_fast(theta, infection_history_mat, vaccination_hist_info, abkinetics_model, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, nrows_per_blood_sample, measurement_strain_indices, antigenic_maps, antigenic_distances, mus, boosting_vec_indices, boost_before_infection));
    return rcpp_result_gen;
END_RCPP
}
// inf_mat_prior_cpp
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(inf_hist_prop_prior_v2_and_v4(theta, infection_history_mat, vaccination_hist_info, abkinetics_model, old_probs_1, sampled_indivs, n_years_samp_vec, age_mask, strain_mask, n_alive, n_infections, n_infected_group, prior_lookup, swap_propn, swap_distance, propose_from_prior, alpha, beta, circulation_times, circulation_times_indices, sample_times, rows_per_indiv_in_samples, cum_nrows_per_individual_in_data, cum_nrows_per_individual_in_repeat_data, nrows_per_blood_sample, group_id_vec, measurement_strain_indices, antigenic_maps, antigenic_distances, data, repeat_data, repeat_indices, titre_shifts, proposal_iter, accepted_iter, proposal_swap, accepted_swap, overall_swap_proposals, overall_add_proposals, time_sample_probs, mus, boosting_vec_indices, total_alive, temp, solve_likelihood));
    return rcpp_result_gen;
END_RCPP
}
// wane_function
...
static const R_CallMethodDef CallEntries[] = {
    {"_serosolver_titre_data_fast_individual_base", (DL_FUNC) &_serosolver_titre_data_fast_individual_base, 7},
    {"_serosolver_fun_cpp", (DL_FUNC) &_serosolver_fun_cpp, 1},
    {"_serosolver_timesTwo", (DL_FUNC) &_serosolver_timesTwo, 1},
    {"_serosolver_makeFuncPtr", (DL_FUNC) &_serosolver_makeFuncPtr, 1},
    ...
    {"_serosolver_titre_data_fast", (DL_FUNC) &_serosolver_titre_data_fast, 16},
